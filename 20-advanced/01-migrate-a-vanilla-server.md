[Migrate a Vanilla server](#migrate-a-vanilla-server)
...
<a class="anchor" name="migrate-a-vanilla-server"></a>
...
Download this [server template](https://www.mcserversoft.com/backend/files/click.php?id=42), unzip it and place the folder into your /servers folder.
...
![Screenshot of the instance settings window]({assets_url}migrate_vanilla_settings.png)