...
`Depuis MCSS 11.7.0, la manière dont le statut des serveurs est détecté a changée.<br><br>
Windows 7 ne supporte pas cette nouvelle méthode via 'PowerShell', à la place MCSS doit utiliser l'ancienne méthode, moins fiable, de détection avec la console.<br><br>
Les utilisateurs de WIndows Server 2012 R2 peuvent ignorer cet avertissement et mettre à jour leur version de PowerShell vers la 5.1.<br><br>
Voulez vous changer la méthode de détection pour utiliser 'ConsoleRead' ? <br>
