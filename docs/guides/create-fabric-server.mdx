...
![Fabric website](https://mcss.b-cdn.net/docs/guides/fabric/download_fabric.png)
...
<div style={{textAlign: 'center'}}>
  <img src="https://mcss.b-cdn.net/docs/guides/fabric/install_fabric.png" alt="install fabric"/>
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="https://mcss.b-cdn.net/docs/guides/fabric/migrate_server.png" alt="Migrate server"/>
</div>
...
<br/>
<br/>
Many thanks to Kennas for making this wonderful video on how to install Fabric on MCSS (Click on the picture to get to it):<br/>
